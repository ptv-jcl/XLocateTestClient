...
namespace XLocate
{
    public partial class MainForm : Form
    {
        ...
        {
            ReverseSearchOption[] options = new ReverseSearchOption[]
            {
        ...
        private void btnProcessAddress_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if ((evtButton.Equals(btnFindAddress)) || (evtButton.Equals(btnMatchAddress)))
                {
                    ...
                    {
                        startTime = DateTime.Now;
                        resultAddress = locateService.matchAddress(inputAddress, searchOption, null, resultField_Address, cc);
                        displayTransactionTime(startTime);
                    }
                }
                else if ((evtButton.Equals(btnFindLocation)) || (evtButton.Equals(btnMatchLocation)))
                {
                    ...
                    if (evtButton.Equals(btnFindLocation))
                    {
                        startTime = DateTime.Now;
                    ...
                    {
                        startTime = DateTime.Now;
                        resultAddress = locateService.matchLocation(inputLocation.coordinate, lstReverseSearchOptions.ToArray(), null, resultField_Location, cc);
                        displayTransactionTime(startTime);
                        if (cbxFilterCity.Checked && (resultAddress != null))
                            resultAddress = filter2city(resultAddress);
                    }
                }
        ...
        public void resetButtons()
        {
            ...
            btnMatchAddress.BackColor = System.Drawing.Color.White;
            btnMatchAddress.Update();
            btnFindLocation.BackColor = System.Drawing.Color.White;
            btnFindLocation.Update();
            btnMatchLocation.BackColor = System.Drawing.Color.White;
            btnMatchLocation.Update();
